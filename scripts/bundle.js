    ...
    (function (e) {
      e.exports = (function () {
        ...
        function q(e, t) {
          return function (a) {
            return null != a
              ? (Z(this, e, a), n.updateOffset(this, t), this)
              : K(this, e);
          };
        }
        ...
        function xe(e, t) {
          ...
          var a,
            s = ((t % (a = 12)) + a) % a;
          return (
            (e += (t - s) / 12), 1 === s ? (G(e) ? 29 : 28) : 31 - ((s % 7) % 2)
          );
        }
        ...
        var Oe = "January_February_March_April_May_June_July_August_September_October_November_December".split(
            "_"
          ),
        ...
        A("H", ["HH", 2], 0, "hour"),
          ...
          A("hmmss", 0, 0, function () {
            return (
              "" + tt.apply(this) + x(this.minutes(), 2) + x(this.seconds(), 2)
            );
          }),
          A("Hmm", 0, 0, function () {
        ...
        function ht(e) {
          ...
          return (function (e) {
            for (var t, a, s, n, r = 0; r < e.length; ) {
              for (
                t = (n = ut(e[r]).split("-")).length,
                  a = (a = ut(e[r + 1])) ? a.split("-") : null;
                t > 0;
          ...
          return (
            a &&
              ...
              ((t =
                a[ge] < 0 || a[ge] > 11
                  ? ge
                  : a[Te] < 1 || a[Te] > xe(a[De], a[ge])
                  ? Te
                  : a[we] < 0 ||
                    a[we] > 24 ||
                    (24 === a[we] &&
                      (0 !== a[ve] || 0 !== a[be] || 0 !== a[Se]))
                  ? we
                  : a[ve] < 0 || a[ve] > 59
                  ? ve
                  : a[be] < 0 || a[be] > 59
                  ...
                  ? Se
                  : -1),
              M(e)._overflowDayOfYear && (t < De || t > Te) && (t = Te),
              M(e)._overflowWeeks && -1 === t && (t = He),
              M(e)._overflowWeekday && -1 === t && (t = je),
              (M(e).overflow = t)),
            e
          );
        }
                ...
                e._w &&
                  ...
                  (function (e) {
                    ...
                    null != (t = e._w).GG || null != t.W || null != t.E
                      ? ((r = 1),
                        (i = 4),
                        (a = bt(t.GG, e._a[De], Ge(Ot(), 1, 4).year)),
                        (s = bt(t.W, 1)),
                        ((n = bt(t.E, 1)) < 1 || n > 7) && (_ = !0))
                      : ((r = e._locale._week.dow),
                        (i = e._locale._week.doy),
                        (o = Ge(Ot(), r, i)),
                        (a = bt(t.gg, e._a[De], o.year)),
                        (s = bt(t.w, o.week)),
                        null != t.d
                          ? ((n = t.d) < 0 || n > 6) && (_ = !0)
                          : null != t.e
          ...
          if (e._f !== n.ISO_8601)
            if (e._f !== n.RFC_2822) {
              ...
              (M(e).charsLeftOver = o - u),
                ...
                null !== (d = M(e).era) &&
                  (e._a[De] = e._locale.erasConvertYear(d, e._a[De])),
                St(e),
                Mt(e);
            } else vt(e);
          else Tt(e);
        ...
        function Ft(e) {
          ...
          (this._isValid = (function (e) {
            ...
            for (t in e)
              if (
                d(e, t) &&
                (-1 === ke.call(At, t) || (null != e[t] && isNaN(e[t])))
              )
                return !1;
        ...
        function It(e, t) {
          ...
          return t._isUTC
            ? ((a = t.clone()),
              (s =
                (D(e) || m(e) ? e.valueOf() : Ot(e).valueOf()) - a.valueOf()),
          ...
          return (
            zt(e)
              ...
              : "object" == typeof o &&
                ...
                (n =
                  r.isValid() && i.isValid()
                    ? ((i = It(i, r)),
                      r.isBefore(i)
                        ? (_ = Zt(r, i))
                        : (((_ = Zt(i, r)).milliseconds = -_.milliseconds),
                          (_.months = -_.months)),
                      _)
                    : {
                        milliseconds: 0,
                ...
                (o.M = n.months)),
            (s = new Ft(o)),
            zt(e) && d(e, "_locale") && (s._locale = e._locale),
            zt(e) && d(e, "_isValid") && (s._isValid = e._isValid),
            s
          );
        }
        ...
        function Qt(e, t, a, s) {
          ...
          e.isValid() &&
            ((s = null == s || s),
            d && Fe(e, K(e, "Month") + d * a),
            i && Z(e, "Date", K(e, "Date") + i * a),
        ...
        function ma(e, t, a) {
          return e < 100 && e >= 0
            ? new Date(e + 400, t, a) - oa
            : new Date(e, t, a).valueOf();
        }

        function la(e, t, a) {
          return e < 100 && e >= 0
            ? Date.UTC(e + 400, t, a) - oa
            : Date.UTC(e, t, a);
        }
          ...
          ye(["yo"], function (e, t, a, s) {
            ...
            a._locale._eraYearOrdinalRegex &&
              ...
              a._locale.eraYearOrdinalParse
                ? (t[De] = a._locale.eraYearOrdinalParse(e, n))
                : (t[De] = parseInt(e, 10));
          }),
          A(0, ["gg", 2], 0, function () {
        ...
        (ga.add = Xt),
            ...
            switch (((a = this._isUTC ? la : ma), e)) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t +=
                    _a -
                    ua(t + (this._isUTC ? 0 : this.utcOffset() * da), _a) -
                    1);
                break;
              case "minute":
          ...
          (ga.from = function (e, t) {
            return this.isValid() && ((D(e) && e.isValid()) || Ot(e).isValid())
              ? qt({
                  to: this,
                  from: e
                })
          ...
          (ga.startOf = function (e) {
            ...
            switch (((a = this._isUTC ? la : ma), e)) {
              ...
              case "hour":
                (t = this._d.valueOf()),
                  (t -= ua(t + (this._isUTC ? 0 : this.utcOffset() * da), _a));
                break;
              case "minute":
        ...
        (wa.calendar = function (e, t, a) {
          ...
          (wa.preparse = Ta),
          (wa.postformat = Ta),
          (wa.relativeTime = function (e, t, a, s) {
          ...
          (wa.set = function (e) {
            var t, a;
            for (a in e)
              d(e, a) && (S((t = e[a])) ? (this[a] = t) : (this["_" + a] = t));
            (this._config = e),
          ...
          (wa.erasAbbrRegex = function (e) {
            return (
              d(this, "_erasAbbrRegex") || ha.call(this),
              e ? this._erasAbbrRegex : this._erasRegex
            );
          }),
          (wa.erasNameRegex = function (e) {
            return (
              d(this, "_erasNameRegex") || ha.call(this),
              e ? this._erasNameRegex : this._erasRegex
            );
          }),
          (wa.erasNarrowRegex = function (e) {
            return (
              d(this, "_erasNarrowRegex") || ha.call(this),
          ...
          (wa.monthsParse = function (e, t, a) {
            ...
            if (this._monthsParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "MMM" === t
                    ? -1 !== (n = ke.call(this._shortMonthsParse, i))
                      ? n
                      : null
                    : -1 !== (n = ke.call(this._longMonthsParse, i))
                    ? n
                    : null
                  : "MMM" === t
                  ? -1 !== (n = ke.call(this._shortMonthsParse, i))
          ...
          (wa.monthsRegex = function (e) {
            return this._monthsParseExact
              ? (d(this, "_monthsRegex") || Ne.call(this),
                e ? this._monthsStrictRegex : this._monthsRegex)
              : (d(this, "_monthsRegex") || (this._monthsRegex = Ae),
          ...
          (wa.monthsShortRegex = function (e) {
            return this._monthsParseExact
              ...
              : (d(this, "_monthsShortRegex") || (this._monthsShortRegex = Ee),
          ...
          (wa.weekdaysParse = function (e, t, a) {
            ...
            if (this._weekdaysParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "dddd" === t
                    ? -1 !== (n = ke.call(this._weekdaysParse, i))
                      ? n
                      : null
                    : "ddd" === t
                    ? -1 !== (n = ke.call(this._shortWeekdaysParse, i))
                      ? n
                      : null
                    : -1 !== (n = ke.call(this._minWeekdaysParse, i))
                    ? n
                    : null
                  : "dddd" === t
                  ? -1 !== (n = ke.call(this._weekdaysParse, i))
        ...
        function as() {
          ...
          return m
            ? ((e = V(_ / 60)),
              ...
              (n = m < 0 ? "-" : ""),
              (r = ts(this._months) !== ts(m) ? "-" : ""),
              (i = ts(this._days) !== ts(m) ? "-" : ""),
              (d = ts(this._milliseconds) !== ts(m) ? "-" : ""),
              n +
                "P" +
                (a ? r + a + "Y" : "") +
                (u ? r + u + "M" : "") +
        ...
        return (
          ...
          (ss.abs = function () {
            var e = this._data;
            return (
              (this._milliseconds = Ha(this._milliseconds)),
              (this._days = Ha(this._days)),
              (this._months = Ha(this._months)),
              (e.milliseconds = Ha(e.milliseconds)),
              (e.seconds = Ha(e.seconds)),
              (e.minutes = Ha(e.minutes)),
              (e.hours = Ha(e.hours)),
              (e.months = Ha(e.months)),
              (e.years = Ha(e.years)),
              this
            );
          }),
          ...
          (ss.as = function (e) {
            ...
            if ("month" === (e = R(e)) || "quarter" === e || "year" === e)
              switch (
                ((t = this._days + s / 864e5), (a = this._months + Oa(t)), e)
              ) {
                case "month":
                  return a;
                case "quarter":
          ...
          (n.updateLocale = function (e, t) {
            if (null != t) {
              ...
              null != dt[e] && null != dt[e].parentLocale
                ? dt[e].set(H(dt[e]._config, t))
                : (null != (s = mt(e)) && (n = s._config),
                  (t = H(n, t)),
                  null == s && (t.abbr = e),
                  ((a = new j(t)).parentLocale = dt[e]),
                  (dt[e] = a)),
                lt(e);
            } else
              null != dt[e] &&
                (null != dt[e].parentLocale
                  ? ((dt[e] = dt[e].parentLocale), e === lt() && lt(e))
  ...
  function (e, t, a) {
    (function () {
      var e,
        ...
        n,
        r = [].slice;
      (e = null != (s = a(140)) ? s : this.countdown),
        ((t = null != (n = a(0)) ? n : this.moment).fn.countdown = function () {
          var a, s;
          return (
            (s = arguments[0]),
            (a = 2 <= arguments.length ? r.call(arguments, 1) : []),
            e.apply(null, [this.toDate(), t(s).toDate()].concat(r.call(a)))
          );
        });
    }.call(this));
  },
  function (e, t) {
    ...
    !(function (e) {
      ...
      function b(e, t) {
        ...
        var a = +e.value || 0;
        return a
          ? (t.setTime(t.getTime() + a), t)
          : ((a = +e.milliseconds || 0) &&
              t.setMilliseconds(t.getMilliseconds() + a),
            (a = +e.seconds || 0) && t.setSeconds(t.getSeconds() + a),
            (a = +e.minutes || 0) && t.setMinutes(t.getMinutes() + a),
            (a = +e.hours || 0) && t.setHours(t.getHours() + a),
            (a = +e.weeks || 0) && (a *= y),
            (a += +e.days || 0) && t.setDate(t.getDate() + a),
            (a = +e.months || 0) && t.setMonth(t.getMonth() + a),
            (a = +e.millennia || 0) && (a *= D),
            (a += +e.centuries || 0) && (a *= k),
            (a += +e.decades || 0) && (a *= p),
            (a += +e.years || 0) && t.setFullYear(t.getFullYear() + a),
            t);
      }
      var S, H, j, x, O, P, W, E;
              ...
              (function (e, t) {
                switch (t) {
                  ...
                  case "days":
                    ...
                    e.weeks++, (e.days = 0);
                  case "weeks":
                    if (e.weeks !== v(e.refMonth) / y || isNaN(e.months))
                      return;
                    e.months++, (e.weeks = 0);
                  case "months":
      ...
      function N(e, t) {
        var a,
          s,
          n,
          r = z(e, 0, "milliseconds", "seconds", c, t);
        if (
          r &&
          (r = z(e, r, "seconds", "minutes", h, t)) &&
          (r = z(e, r, "minutes", "hours", M, t)) &&
          (r = z(e, r, "hours", "days", L, t)) &&
          (r = z(e, r, "days", "weeks", y, t)) &&
          (r = z(e, r, "weeks", "months", v(e.refMonth) / y, t)) &&
          (r = z(
            e,
            r,
            "months",
            ...
            ((a = e.refMonth),
            (s = a.getTime()),
            (n = new Date(s)).setFullYear(a.getFullYear() + 1),
            Math.round((n.getTime() - s) / Y) / v(e.refMonth)),
            t
          )) &&
          (r = z(e, r, "years", "decades", p, t)) &&
          (r = z(e, r, "decades", "centuries", k, t)) &&
          (r = z(e, r, "centuries", "millennia", D, t))
        )
      ...
      function J(e, l, Y, v, b, S) {
        ...
        try {
          (e.millennia = 0),
            (e.centuries = 0),
            (e.decades = 0),
            (e.years = Y.getFullYear() - l.getFullYear()),
            (e.months = Y.getMonth() - l.getMonth()),
            (e.weeks = 0),
            (e.days = Y.getDate() - l.getDate()),
            (e.hours = Y.getHours() - l.getHours()),
            (e.minutes = Y.getMinutes() - l.getMinutes()),
            (e.seconds = Y.getSeconds() - l.getSeconds()),
            (e.milliseconds = Y.getMilliseconds() - l.getMilliseconds()),
            (function (e) {
              var t;
              for (
                e.milliseconds < 0
                  ? ((t = g(-e.milliseconds / c)),
                    (e.seconds -= t),
                    (e.milliseconds += t * c))
                  : e.milliseconds >= c &&
                    ((e.seconds += T(e.milliseconds / c)),
                    (e.milliseconds %= c)),
                  e.seconds < 0
                    ? ((t = g(-e.seconds / h)),
                      (e.minutes -= t),
                      (e.seconds += t * h))
                    : e.seconds >= h &&
                      ((e.minutes += T(e.seconds / h)), (e.seconds %= h)),
                  e.minutes < 0
                    ? ((t = g(-e.minutes / M)),
                      (e.hours -= t),
                      (e.minutes += t * M))
                    : e.minutes >= M &&
                      ((e.hours += T(e.minutes / M)), (e.minutes %= M)),
                  e.hours < 0
                    ? ((t = g(-e.hours / L)), (e.days -= t), (e.hours += t * L))
                    : e.hours >= L &&
                      ((e.days += T(e.hours / L)), (e.hours %= L));
                e.days < 0;

              )
                e.months--, (e.days += w(e.refMonth, 1));
              e.days >= y && ((e.weeks += T(e.days / y)), (e.days %= y)),
                e.months < 0
                  ? ((t = g(-e.months / f)),
                    (e.years -= t),
                    (e.months += t * f))
                  : e.months >= f &&
                    ((e.years += T(e.months / f)), (e.months %= f)),
                e.years >= p &&
                  ((e.decades += T(e.years / p)),
                  (e.years %= p),
                  e.decades >= k &&
                    ((e.centuries += T(e.decades / k)),
                    (e.decades %= k),
                    e.centuries >= D &&
                      ((e.millennia += T(e.centuries / D)),
                      (e.centuries %= D))));
            })(e),
            (function (e, l, Y, g) {
              var v = 0;
              !(l & m) || v >= Y
                ? ((e.centuries += e.millennia * D), delete e.millennia)
                : e.millennia && v++,
                !(l & u) || v >= Y
                  ? ((e.decades += e.centuries * k), delete e.centuries)
                  : e.centuries && v++,
                !(l & o) || v >= Y
                  ? ((e.years += e.decades * p), delete e.decades)
                  : e.decades && v++,
                !(l & _) || v >= Y
                  ? ((e.months += e.years * f), delete e.years)
                  : e.years && v++,
                !(l & d) || v >= Y
                  ? (e.months && (e.days += w(e.refMonth, e.months)),
                    delete e.months,
                    e.days >= y && ((e.weeks += T(e.days / y)), (e.days %= y)))
                  : e.months && v++,
                !(l & i) || v >= Y
                  ? ((e.days += e.weeks * y), delete e.weeks)
                  : e.weeks && v++,
                !(l & r) || v >= Y
                  ? ((e.hours += e.days * L), delete e.days)
                  : e.days && v++,
                !(l & n) || v >= Y
                  ? ((e.minutes += e.hours * M), delete e.hours)
                  : e.hours && v++,
                !(l & s) || v >= Y
                  ? ((e.seconds += e.minutes * h), delete e.minutes)
                  : e.minutes && v++,
                !(l & a) || v >= Y
                  ? ((e.milliseconds += e.seconds * c), delete e.seconds)
                  : e.seconds && v++,
                (l & t && !(v >= Y)) || N(e, g);
            })(e, v, b, S);
        } finally {
      ...
      (F.prototype.toString = function (e) {
        ...
        (E = function (e) {
          ...
          return (
            a && t.push(P(a, 10)),
            (a = e.centuries) && t.push(P(a, 9)),
            (a = e.decades) && t.push(P(a, 8)),
            (a = e.years) && t.push(P(a, 7)),
            (a = e.months) && t.push(P(a, 6)),
            (a = e.weeks) && t.push(P(a, 5)),
            (a = e.days) && t.push(P(a, 4)),
            (a = e.hours) && t.push(P(a, 3)),
            (a = e.minutes) && t.push(P(a, 2)),
            (a = e.seconds) && t.push(P(a, 1)),
            (a = e.milliseconds) && t.push(P(a, 0)),
            t
          );
        }),
        (R.MILLISECONDS = t),
      ...
      var C = (R.setFormat = function (e) {
          if (e) {
            if ("singular" in e || "plural" in e) {
              ...
              a.split && (a = a.split("|"));
              for (var s = 0; s <= 10; s++)
                (S[s] = t[s] || S[s]), (H[s] = a[s] || H[s]);
            }
            "string" == typeof e.last && (j = e.last),
              "string" == typeof e.delim && (x = e.delim),
              "string" == typeof e.empty && (O = e.empty),
              "function" == typeof e.formatNumber && (W = e.formatNumber),
              "function" == typeof e.formatter && (P = e.formatter);
          }
        }),
        I = (R.resetFormat = function () {
          (S = " millisecond| second| minute| hour| day| week| month| year| decade| century| millennium".split(
            "|"
          )),
            (H = " milliseconds| seconds| minutes| hours| days| weeks| months| years| decades| centuries| millennia".split(
              "|"
            )),
            (j = " and "),
            (x = ", "),
    ...
    !(function (e) {
      ...
      setInterval(function () {
        var a = t().countdown(
          ...
          d = t().countdown(e);
        (d = Math.floor(1.1574074 * d.value * Math.pow(10, -8))),
          (s.innerText = d < 10 && d >= 0 ? "0" + d : d < 0 ? "00" : d),
          a.hours < 10 && a.hours >= 0
            ? (n.innerText = "0" + a.hours)
            : (n.innerText = a.hours),
          a.minutes < 10
            ? (r.innerText = "0" + a.minutes)
            : (r.innerText = a.minutes),
          a.seconds < 10
            ? (i.innerText = "0" + a.seconds)
            : (i.innerText = a.seconds),
          d < 0 &&
            a.hours < 0 &&
            ((s.innerText = "00"),
            (n.innerText = "00"),
